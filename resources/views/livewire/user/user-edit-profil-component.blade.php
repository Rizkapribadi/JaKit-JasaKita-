    ...
    <div class="container" style="padding:30px 0;">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateBiodata">
                        @csrf
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-lable">Avatar</label>
                                <div class="col-md-4">
                                    <input type="file" class="input-file" wire:model="newimage"/>
                                    @if($newimage)
                                        <img src="{{ $newimage->temporaryUrl() }}" width="120" />
                                    @else
                                        <img src="{{ asset('assets/images/avatars') }}/{{ $profile_photo_path }}" width="120" />
                                    @endif
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <a href="{{ route('user.changepassword') }}" class="btn btn-success">Change Password</a>
                </div>

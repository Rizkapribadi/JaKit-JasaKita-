                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.profile') }}" class="btn btn-success pull-right">My Profile</a>
                            </div>
                        </div>
                    </div>  
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="changePassword">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="enter your current password" class="form-control input-md" name="current_password" wire:model="current_password" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="enter your new password" class="form-control input-md" name="password" wire:model="password" />
